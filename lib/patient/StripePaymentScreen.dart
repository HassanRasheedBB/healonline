...
class _PaymentState extends State<StripePaymentScreen> {
  Token _paymentToken;
  PaymentMethod _paymentMethod;
  String _error;
  final String _currentSecret = "sk_test_51IihHYAxBEX6NY9bSZPmiNK2FMpJM8kIakW0RAskzjP8mjOLr7sWVS2ybAXvo1RZGXI4CGDnyThT9q67pWWl5nuU005u4cq3zn"; //set this yourself, e.g using curl
  ...
  initState() {
    ...
    StripePayment.setOptions(
        StripeOptions(publishableKey: "pk_test_51IihHYAxBEX6NY9bvPxLtPO014aaV18ki7GHWQNG8QTUzdPgyPKFnf9Sr2A85EsaU8zWdtRNsYwsHXH2n8CroS8300PhP6FXCw",
